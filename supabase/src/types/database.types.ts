  ...
  public: {
    ...
    Functions: {
      ...
      billing_receivable_has_boleto: {
        Args: { p_billing_receivable_id: string }
        Returns: boolean
      }
      calculate_anticipation_valor_liquido: {
        Args: { p_receivable_ids: string[]; p_company_id: string }
        Returns: number
      }
      calculate_index_adjustment: {
        Args: { p_index_id: string; p_start_date: string; p_end_date: string }
        Returns: number
      }
      calculate_payment_plan_installments: {
        Args: { p_payment_plan_settings_id: string }
        Returns: undefined
      }
      execute_sql: {
      ...
      get_initial_receivable_status: {
        Args: { project_id: string; buyer_cpf: string }
